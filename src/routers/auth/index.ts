...
import { attachLoginWithGithubHandler } from './loginWithGithubHandler.js';
import { attachLoginWithGoogleHandler } from './loginWithGoogleHandler.js';
import { attachLoginWithMicrosoftHandler } from './loginWithMicrosoftHandler.js';
...
import { attachPolarCheckoutHandler } from './polarCheckoutHandler.js';
import { attachPolarWebhookHandler } from './polarWebhookHandler.js';
import { attachPremiumWinbackHandler } from './premiumWinbackHandler.js';
...
attachLoginWithGithubHandler(router);
attachLoginWithStravaHandler(router);
attachLoginWithMicrosoftHandler(router);
attachPatchUserHandler(router);
attachPurchaseTokenHandler(router);
attachPurchaseValidateHandler(router);
attachPolarCheckoutHandler(router);
attachPolarWebhookHandler(router);
attachPremiumWinbackHandler(router);
